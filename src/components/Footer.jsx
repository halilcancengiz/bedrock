    ...
    return (
        <footer className='border-t'>
            <motion.div
                ...
                className="mx-auto max-w-[1221px] w-full flex flex-col items-center justify-between text-[18px] px-6 leading-[20px] so-medium pt-20 mb-10 text-t-primary">
                ...
                <div className='flex lg:flex-nowrap justify-between flex-wrap w-full'>
                    <div className='flex flex-col mr-10 lg:mb-[15px] mb-[35px] max-w-[357px] w-full items-start'>
                        <Logo />
                        {/* <div className='leading-[30px] mt-[10px] so-medium'>
                    ...
                    <div className='flex flex-col gap-y-4 md:flex-nowrap flex-wrap'>
                        ...
                        <div style={{ boxShadow: '0px 8px 44px 0px rgba(8, 15, 52, 0.03)' }} className='group cursor-pointer rounded-md flex items-center gap-x-3 hover-up-md py-[21px] px-6 border border-neutral-300'>
                            ...
                            <a href={`tel:${import.meta.env.VITE_CONTACT_PHONE}`} className='flex flex-col items-center justify-center text-white'>
                                <div className='tb-bold text-t-primary text-[18px] group-hover:text-primary transition-colors duration-300'>{`${import.meta.env.VITE_CONTACT_PHONE}`}</div>
                            </a>
                        </div>
                    </div>
                </div>

                <div className='mt-5 border-b w-full md:flex-row flex-col gap-y-6 flex items-center justify-between border-neutral-400 pb-2'>
                    <div className='flex xs:flex-row flex-col items-center gap-6'>
                        <NavLink to="/impressum" className='hover:text-primary transition-all duration-300 so-medium'>Impressum</NavLink>
                        <NavLink to="/datenschutz" className='hover:text-primary transition-all duration-300 so-medium'>Datenschutzerklärung</NavLink>
                    </div>
                </div>
