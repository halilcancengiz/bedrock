        ...
        <motion.div
          ...
          <div className="flex flex-col">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="text-t-primary  md:text-[38px] xs:text-[32px] text-[26px] lg:mb-4 mb-[10px] md:leading-[50.008px] xs:leading-[42.112px] leading-[34.216px]">Datenschutzerklärung</motion.div>
            <motion.div
              variants={fadeInAnimationVariant}
              initial="initial"
              whileInView="animate"
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="text-t-primary text-[18px]  md:mb-8 mb-[26px] leading-[30.006px]">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="text-t-primary  md:text-[24px] xs:text-[22px] text-[20px] lg:mb-4 mb-[10px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px] mt-2">
              I. Definitionen
            </motion.div>
            <motion.div
              variants={fadeInAnimationVariant}
            ...
            <motion.div c
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              lassName="text-t-primary  md:text-[24px] xs:text-[22px] text-[20px] lg:mb-4 mb-[10px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px] mt-2">
              II. Verantwortlicher
            </motion.div>
            <div className="text-t-primary text-[18px]  md:mb-8 mb-[26px] leading-[30.006px]">
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              >  JOBSADVISION GmbH <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > Brucknerstraße 2 <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              >  75015 Bretten, Deutschland <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
                className=" mr-1">Handelsregister/Nr.:
              </motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > Amtsgericht Mannheim, HRB 731879 <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
                className=" mr-1">Geschäftsführer:
              </motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > +49 (0) 7252 / 580 787 0 <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              >info@jobsadvision.de <br /><br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
                className=" mr-1">Datenschutzbeauftragter:
              </motion.span> <br />
              <motion.span
                variants={fadeInAnimationVariant}
                initial="initial"
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > Giovanni Morello <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > +49 (0) 7252 / 5807870 <br /></motion.span>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3, duration: 0.3 }}
              > g.morello@jobsadvision.de <br /></motion.span>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="text-t-primary text-[18px]  md:mb-8 mb-[26px] leading-[30.006px] pl-7">
            ...
            <motion.div
              ...
              Wurde die Verarbeitung der Sie betreffenden personenbezogenen Daten eingeschränkt, dürfen diese Daten - von ihrer Speicherung abgesehen - nur mit Ihrer Einwilligung oder zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen oder zum Schutz der Rechte einer anderen natürlichen oder juristischen Person oder aus Gründen eines wichtigen öffentlichen Interesses der Union oder eines Mitgliedstaats verarbeitet werden. Wurde die Einschränkung der Verarbeitung nach den o.g. Voraussetzungen eingeschränkt, werden Sie von dem Verantwortlichen unterrichtet bevor die Einschränkung aufgehoben wird.            </motion.div>
            <motion.div
              variants={fadeInAnimationVariant}
              initial="initial"
              whileInView="animate"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.3, duration: 0.3 }}
              className="text-t-primary text-[18px]  md:mb-8 mb-[26px] leading-[30.006px] break-all">
