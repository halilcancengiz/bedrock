    ...
    <section className="py-[72px] px-6 relative bg-secondary">
      ...
      <div className="max-w-[1173px] w-full mx-auto flex lg:flex-row flex-col relative">
        ...
        <motion.div
          ...
          className="flex flex-col h-full rounded-lg bg-white w-full lg:pt-[80px] md:pt-[70px] xs:pt-[60px] pt-[50px] lg:px-[91px] md:px-[76px] xs:px-[35px] px-[25px] lg:pb-[108px] md:pb-[90px] xs:pb-[75px] pb-[63px] border border-neutral-300">
          <div id="terms-and-conditions" className="flex flex-col">
            <div className="text-neutral-800 so-bold md:text-[38px] xs:text-[32px] text-[26px] lg:mb-4 mb-[10px] md:leading-[50.008px] xs:leading-[42.112px] leading-[34.216px]">Datenschutzerklärung</div>
            <div className="text-t-primary text-[18px] so-regular md:mb-8 mb-[26px] leading-[30.006px]">
            ...
            <div className="text-neutral-800 so-bold md:text-[24px] xs:text-[22px] text-[20px] lg:mb-4 mb-[10px] md:leading-[34.008px] xs:leading-[31.174px] leading-[28.34px] mt-2">
              I. Definitionen
            </div>
            <div className="text-t-primary text-[18px] so-regular md:mb-8 mb-[26px] leading-[30.006px]">
            ...
            <div className="text-t-primary text-[18px] so-regular md:mb-8 mb-[26px] leading-[30.006px]">
              <span className="so-semibold mr-1">Name/Fa.:</span> JOBSADVISION GmbH <br />
              <span className="so-semibold mr-1">Straße Nr.:</span> Brucknerstraße 2 <br />
              <span className="so-semibold mr-1">PLZ, Ort, Land:</span> 75015 Bretten, Deutschland <br />
              <span className="so-semibold mr-1">Handelsregister/Nr.:</span> Amtsgericht Mannheim, HRB 731879 <br />
              <span className="so-semibold mr-1">Geschäftsführer:</span> Sigurd Mendel <br />
              <span className="so-semibold mr-1">Telefonnummer:</span> +49 (0) 7252 / 580 787 0 <br />
              <span className="so-semibold mr-1">E-Mailadresse:</span> info@jobsadvision.de <br /><br />
              <span className="so-semibold mr-1">Datenschutzbeauftragter:</span> <br />
              <span className="so-semibold mr-1">Name:</span> Giovanni Morello <br />
              <span className="so-semibold mr-1">Straße Nr.:</span> Brucknerstraße 2 <br />
              <span className="so-semibold mr-1">PLZ, Ort, Land:</span> 75015 Bretten, Deutschland <br />
              <span className="so-semibold mr-1">Telefonnummer:</span> +49 (0) 7252 / 5807870 <br />
              <span className="so-semibold mr-1">E-Mailadresse:</span> g.morello@jobsadvision.de <br />
            </div>
            ...
            <div className="text-t-primary text-[18px] so-regular md:mb-8 mb-[26px] leading-[30.006px] pl-7">
